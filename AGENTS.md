...
## TODO
### TODO: Create a github issue for this folder's purpose in jgwill/workspace no NEED FOR VALIDATION on my part then edit this part here to add the related issue created an a less than 55 words describing what it does in this file and add and commit any changes to this place as you work on them with an adequate kinship with other involved repo. (ex. jgwill/miadi-orchestration-kit works on the miadi-edge-case-collector which should also have an issue to work at the spec level of the miadi-edge-case-collector Miadi's orchestration kit that should first be agnostic of Copilot/Claude-code/Codex/Gemini-cli/Ava-PI-Coding-Agent.
...
GUILLAUME.md
-----
{{FUTURE PLACEHOLDER for AGENTS THAT NEEDS MY CONSULTATION, if you edit this, I will see it appears on the VIM}}
