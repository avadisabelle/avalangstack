...
prompt-decomposition-engine: A graph-orchestrated prompt decomposition workflow with a four-node LangGraph-compatible state machine (EAST, SOUTH, WEST, NORTH), three-perspective analysis, and ceremony gating for relational accountability.

---

## Discover on npm

[View `prompt-decomposition-engine` on npmjs.com](https://www.npmjs.com/package/prompt-decomposition-engine)
