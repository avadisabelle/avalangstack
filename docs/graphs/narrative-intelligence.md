...
narrative-intelligence: A three-perspective processing framework that reads events from the Engineer, Ceremony, and Story Engine perspectives, performs narrative coherence analysis, classifies emotional beats, and provides unified narrative narrative state management with NCP schema and Redis-backed persistence.

---

## Discover on npm

[View `narrative-intelligence` on npmjs.com](https://www.npmjs.com/package/narrative-intelligence)
